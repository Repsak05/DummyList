        ...
        <View style={{ flex: 1, backgroundColor: "#D0E4FF" }}>
            ...
            <View style={{ alignItems: "center" }}>
                ...
                <View style={{ flexDirection: "column", width: "70%" }}>
                    <View style={{ marginBottom: 20 }}>
                        <EnterInformationLogInComponent
                            ...
                            placeholder='Email'
                            onChangeText={setEmail} // Using onChangeText to directly set email
                        />
                    </View>
                    <View style={{}}>
                        <EnterInformationLogInComponent
                            ...
                            onChangeText={setPassword} // Using onChangeText to directly set password
                ...
                <View style={{ flexDirection: "row", marginTop: 15 }}>
                    ...
                    <Pressable onPress={() => { console.log("Navigate to sign up page"); navigation.navigate("SignUpPage") }}>
