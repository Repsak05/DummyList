...
export default function CreateChallengeComponent({navigation})
{
    ...
    return(
        <Pressable onPress={openCreateChallenge} style={[style.wrapper, style.roundedCornersOpposite, {borderWidth: 10, borderColor: "#767B82", backgroundColor: "#42474E", height: 204, justifyContent: "center", position: "relative"}]}>
